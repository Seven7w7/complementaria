...
select*from pedido order by total desc limit 4;
...
select * from comercial order by comisión desc limit 1;
...
SELECT id,nombre, apellido1 from cliente where apellido2 is not null order by apellido1,nombreapellido1 desc;
